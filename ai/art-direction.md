...
2. **The client does not art-direct.** Clients (especially the German service-business owners this tool serves) have weak design taste and will steer toward the generic if asked. Honor their *facts, voice, story, and explicit no-gos* — originate everything else yourself. A brief's "Visual Direction" block is a loose signal, not a spec. Never treat a client's color/font opinion as a constraint unless it's a listed no-go.
